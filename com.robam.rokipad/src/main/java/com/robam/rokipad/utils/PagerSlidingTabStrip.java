...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int scrollOffset = 82;
    private int indicatorHeight = 4;//字体下面的那条线
    private int underlineHeight = 1;
    private int dividerPadding = 30;
    private int tabPadding = 20;
    private int dividerWidth = 1;

    private int tabTextSize = 26;
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                if (i == selectedPosition) {
                    ...
                    switch (i) {
                        case 1:
                            ...
                            if (stove[0] == null || !stove[0].isConnected()) {
                                tab.setTextColor(0xff565555);
                ...
                if (i == selectedPosition) {
                    ...
                    switch (i) {
                        case 1:
                            stove = Utils.getDefaultStove();
                            if (stove[0] == null || !stove[0].isConnected()) {
                                imageButton.setImageResource(this.blackIconRes[i]);
                ...
                if (iconAndText == TABICONTEXT) {
                    ...
                    tabTxt.setTextSize(tabTextSize);
                    ...
                    switch (i) {
                        case 0:
                            ...
                            if (fan == null || !fan.isConnected()) {
                                if (iconAndText == TABICONTEXT) {
                                    tabTxt.setTextColor(0xff565555);
                                    tabIcon.setImageResource(this.blackIconRes[i]);
                                } else if (iconAndText == TABICON) {
                                    tabIcon.setImageResource(this.blackIconRes[i]);
                                } else if (iconAndText == TABTEXT) {
                                    tabTxt.setTextColor(0xff565555);
                        ...
                        case 2:
                            ...
                            if (sterilizer == null || !sterilizer.isConnected()) {
                                if (iconAndText == TABICONTEXT) {
                                    tabTxt.setTextColor(0xff565555);
                                    tabIcon.setImageResource(this.blackIconRes[i]);
                                } else if (iconAndText == TABICON) {
                        ...
                        case 4:
                            ...
                            if (steam == null || !steam.isConnected()) {
                                if (iconAndText == TABICONTEXT) {
                                    tabTxt.setTextColor(0xff565555);
                                    tabIcon.setImageResource(this.blackIconRes[i]);
                                } else if (iconAndText == TABICON) {
                        ...
                        case 5:
                            microwace = Utils.getDefaultMicrowave();
                            if (microwace == null || !microwace.isConnected()) {
                                if (iconAndText == TABICONTEXT) {
                                    tabTxt.setTextColor(0xff565555);
                                    tabIcon.setImageResource(this.blackIconRes[i]);
                                } else if (iconAndText == TABICON) {
                        ...
                        case 6:
                            ...
                            if (waterPurifier == null || !waterPurifier.isConnected()) {
                                if (iconAndText == TABICONTEXT) {
                                    tabTxt.setTextColor(0xff565555);
                                    tabIcon.setImageResource(this.blackIconRes[i]);
                                } else if (iconAndText == TABICON) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        } else if (iconAndText == TABICONTEXT && direction == 1) {
            LinearLayout tab = (LinearLayout) currentTab.findViewById(R.id.ll_container);
            //ll_container是写死的，不能更改
...
//        Log.e("....>",""+width);
        ...
        if (indicatorinFollower) {
            canvas.drawRect(lineLeft + (lineRight - lineLeft - width) / 2 + 10, height - indicatorHeight, lineLeft + width + (lineRight - lineLeft - width) / 2 - 20, height, rectPaint);
        } else {
            //默认设置，底部横线填满宽度
        ...
        for (int i = 0; i < tabCount - 1; i++) {
            ...
            canvas.drawLine(tab.getRight(), dividerPadding + 7, tab.getRight(), height - dividerPadding - 7, dividerPaint);
     ...
     */
    public void setIconAndText(int stateVaule, int direction) {
    ...
    public void setBlackIconRes(int[] bIcon) {
        this.blackIconRes = bIcon;
        updateTabStyles();
    }

    public void setDeviceConnection(IDevice device) {

        if (device != null) {
            if (device instanceof AbsFan) {
                fan = (AbsFan) device;
            } else if (device instanceof Stove) {
                stove[0] = (Stove) device;
            } else if (device instanceof AbsSterilizer) {
                sterilizer = (AbsSterilizer) device;
            } else if (device instanceof AbsOven) {
                oven = (AbsOven) device;
            } else if (device instanceof AbsSteamoven) {
                steam = (AbsSteamoven) device;
            } else if (device instanceof AbsMicroWave) {
                microwace = (AbsMicroWave) device;
            } else if (device instanceof AbsWaterPurifier) {
                waterPurifier = (AbsWaterPurifier) device;
            }
        }
        updateTabStyles();
    }
