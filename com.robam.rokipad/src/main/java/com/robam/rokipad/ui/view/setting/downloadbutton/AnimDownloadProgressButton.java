...
public class AnimDownloadProgressButton extends TextView {
    ...
    //文字大小
    private float mAboveTextSize = 30;
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int bgColor = a.getColor(R.styleable.AnimDownloadProgressButton_progressbtn_background_color, Color.parseColor("#3468d3"));
        //初始化背景颜色数组
        initGradientColor(bgColor, bgColor);
        mBackgroundSecondColor = a.getColor(R.styleable.AnimDownloadProgressButton_progressbtn_background_second_color, Color.parseColor("#10666666"));
        mButtonRadius = a.getFloat(R.styleable.AnimDownloadProgressButton_progressbtn_radius, getMeasuredHeight() / 2);
        mAboveTextSize = a.getFloat(R.styleable.AnimDownloadProgressButton_progressbtn_text_size, 24);
        mTextColor = a.getColor(R.styleable.AnimDownloadProgressButton_progressbtn_text_color, Color.parseColor("#ffffff"));
    ...
    private void setupAnimations() {
        ...
        //ProgressBar的动画
        mProgressAnimation = ValueAnimator.ofFloat(0, 1).setDuration(2500);
