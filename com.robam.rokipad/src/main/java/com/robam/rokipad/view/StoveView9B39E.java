...
public class StoveView9B39E extends FrameLayout implements IStove {
    Context cx;
    View viewRoot;

    @InjectView(R.id.view_left)
    Stove9b39ChildrenView viewLeft;
    @InjectView(R.id.view_right)
    Stove9b39ChildrenView viewRight;
    ...
    public StoveView9B39E(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public StoveView9B39E(Context context) {
        super(context);
        initView(context, null);
    }


    public StoveView9B39E(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        viewRoot = LayoutInflater.from(cx).inflate(
                R.layout.stove_view_9b39, this, true);
    ...
    private void init() {
        ...
        lockLayout.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
//                if (stove.leftHead.status == StoveStatus.Off && stove.rightHead.status == StoveStatus.Off) {
//                    ToastUtils.showShort("请先开启灶具");
//                    return;
//                }
