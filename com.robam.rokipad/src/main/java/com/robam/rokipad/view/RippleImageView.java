...
public class RippleImageView extends RelativeLayout{
    ...
    private static final int IMAMGEVIEW_SIZE = 300;
    /**三张波纹图片*/
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_WAVE2_ANIMATION:
                    ...
                    mAnimationSet[MSG_WAVE2_ANIMATION].setAnimationListener(new Animation.AnimationListener() {
                        @Override
    ...
    private void setLayout(Context context) {
        ...
        for (int i = 0; i <SIZE ; i++) {
            ...
            imgs[i].setImageResource(R.mipmap.point_wave);
            addView(imgs[i],params);
        }

        /**添加背景图片*/
        img_bg=new ImageView(context);
        img_bg.setImageResource(R.mipmap.lock_start);
    ...
    private AnimationSet initAnimationSet() {
        ...
        ScaleAnimation sa = new ScaleAnimation(1f, 2f, 1f, 2f,
                ...
                ScaleAnimation.RELATIVE_TO_SELF, 0.5f);
        sa.setDuration(show_spacing_time * 2);
        //sa.setRepeatCount(Animation.INFINITE);// 设置循环
        //透明度
        AlphaAnimation aa = new AlphaAnimation(1, 0.1f);
        aa.setDuration(show_spacing_time * 2);
    ...
    public void startWaveOne(){
        imgs[0].startAnimation(mAnimationSet[0]);
        mAnimationSet[0].setAnimationListener(new Animation.AnimationListener() {
            @Override
            public void onAnimationStart(Animation animation) {
