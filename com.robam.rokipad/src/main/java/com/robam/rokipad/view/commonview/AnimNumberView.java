...
import static com.robam.rokipad.view.commonview.NumberView.DOWN_ANIMATOR_MODE;
import static com.robam.rokipad.view.commonview.NumberView.UP_ANIMATOR_MODE;
...
public class AnimNumberView extends LinearLayout {
    ...
    private int numberWidth = Utils.dip2px(getContext(), 46);
    private int numberHeight = Utils.dip2px(getContext(), 95);
    ...
    public AnimNumberView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(getContext()).inflate(R.layout.widget_progress_temp_number_layout,
                this, true);
        mSingleView = (NumberView) findViewById(R.id.mSingleNumber);
        mTenView = (NumberView) findViewById(R.id.mTenNumber);
        mHundredView = (NumberView) findViewById(R.id.mHundredNumber);
        mHour1View = (NumberView) findViewById(R.id.mHour1);
        mHour2View = (NumberView) findViewById(R.id.mHour2);
        mMinute1View = (NumberView) findViewById(R.id.mMinute1);
        mMinute2View = (NumberView) findViewById(R.id.mMinute2);
        mSecond1View = (NumberView) findViewById(R.id.mSecond1);
        mSecond2View = (NumberView) findViewById(R.id.mSecond2);
        mColon1View = (TextView) findViewById(R.id.mColon1);
        mColon2View = (TextView) findViewById(R.id.mColon2);
        mTempContainer = (LinearLayout) findViewById(R.id.mTempNumberContainer);
        mClockContainer = (LinearLayout) findViewById(R.id.mClockContainer);
        mTvCircle = (TextView) findViewById(R.id.tv_number_one);
        checkMode(mMode);
    ...
    public void setTemperature(int temperature, int mode) {
        ...
        checkMode(mode);
        //设置控件的尺寸
        numberWidth = Utils.dip2px(getContext(), 46);
        numberHeight = Utils.dip2px(getContext(), 95);
        numberTextSize = 80;
        setLayoutSize(numberWidth, numberHeight, numberTextSize);
    ...
    private void setClock(int second, int mode) {
        ...
        if (mHour1Value > 0) {
            ...
            //展示五位数字
            numberWidth = Utils.dip2px(getContext(), 41);
            numberHeight = Utils.dip2px(getContext(), 85);
            numberTextSize = 72;
            ...
            //展示三位数字
            numberWidth = Utils.dip2px(getContext(), 56);
            numberHeight = Utils.dip2px(getContext(), 114);
            numberTextSize = 92;
            mHour1View.setVisibility(GONE);
            mHour2View.setVisibility(GONE);
            mColon1View.setVisibility(GONE);
