package com.robam.rokipad.view.button;
...
public class MyButton extends FrameLayout implements View.OnTouchListener, A6ButtonInterface {
    ...
    private void initNormalButton() {
        ...
        mTv.setTextAppearance(context, R.style.text_menu);
        if (!TextUtils.isEmpty(text)) {
            mTv.setText(text);
        }

        drawable = new GradientDrawable();
        drawable.setCornerRadius(Utils.dip2px(getContext(), 6));
    ...
    private void initLightButton() {
        ...
        mTv.setGravity(Gravity.CENTER);
        mTv.setTextColor(Color.WHITE);
        mTv.setTextAppearance(context, R.style.text_menu_light);
    ...
    private void initActionButton() {
        ...
        LayoutParams ivLp = new LayoutParams(dip2px(60), dip2px(60));
        ivLp.gravity = Gravity.CENTER;
