...
public class StoveView9B39 extends FrameLayout implements IStove {
    Context cx;
    View viewRoot;
    ...
    public StoveView9B39(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public StoveView9B39(Context context) {
        super(context);
        initView(context, null);
    }


    public StoveView9B39(Context context, AttributeSet attrs, int defStyleAttr) {
