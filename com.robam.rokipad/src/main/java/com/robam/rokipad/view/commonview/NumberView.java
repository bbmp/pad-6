...
public class NumberView extends FrameLayout {
    ...
    private LayoutParams tvFirstLp;
    private MarginLayoutParams tvSecondLp;
    ...
    public NumberView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mTvFirst = (TextView) findViewById(R.id.tv_number_one);
        mTvSecond = (TextView) findViewById(R.id.tv_number_tow);
        init();
    }
