...
public class AbsWheelView2 extends View {
    ...
    protected void init(Context context, AttributeSet attrs) {
        ...
        unitHeight = (int) attribute.getDimension(
                R.styleable.WheelView_unitHight, 80);
...
//        controlHeight = itemNumber * unitHeight + center_above_y+center_below_y;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        LogUtils.i("20180331","conwidth::"+controlWidth);
        if (controlWidth != 0) {
//            setMeasuredDimension(getWidth(), itemNumber * unitHeight - (itemNumber / 2) * (itemNumber / 2 + 1) * heightDiv);
    ...
    public OnSelectListener getOnSelectListeren() {
    ...
    protected void onEndSelect(final ItemObject item) {
        if (onSelectListener != null) {
