...
abstract public class AbsCommonCloudService extends AbsService {
    ...
    public String getAppGuid(String appType, String token,String versionName) {
        return CloudHelper.getAppGuid(appType, token,versionName);
    }

    public void getAppGuid(String appType, String token,String versionName,
                           Callback<String> callback) {
        CloudHelper.getAppGuid(appType, token,  versionName,callback);
    }
