...
public abstract class RuleCookTaskService extends AbsCookTaskService {
    ...
    public void RecipeTempUpEvent(float temp, AbsCookTaskServiceCallBack callBack) {
        try {
            ...
            LogUtils.e("20190610","rules:" + rules);
            if (rules == null || rules.size() == 0) {
                callBack.onCompleted(new PlotRecipeNextEvent("RULE_MANUAL", null, stepIndex));
                return;
            }
            ...
            LogUtils.e("20190610", "type:" + recipeRuleByCode + " order:" + step.order + " stepIndex:" + stepIndex);
