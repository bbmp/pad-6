 ...
 */
public class AbsWaterPurifier extends AbsDeviceHub implements IWaterPurifier {
        ...
        try {
            ...
            switch (key) {
                case MsgKeys.GetWaterPurifiyStatus_Rep://状态查询回应
                    ...
                    onStatusChanged();
                    if (Plat.DEBUG) {
                        LogUtils.i("time_left", "time_left:" + filter_time_cto);
                        LogUtils.i("time_left", "time_left:" + filter_time_ro1);
                        LogUtils.i("time_left", "time_left:" + filter_time_ro2);
                    }
                    break;
                case MsgKeys.GetWaterPurifiyFiliter_Rep://滤芯到期
                    short filiter = (short) msg.optInt(MsgParams.WaterPurifierFiliter);
                    if (Plat.DEBUG)
                        LogUtils.i("aaaaaa", "filiter:" + filiter);
                ...
                case MsgKeys.GetWaterPurifiyAlarm_Rep://报警
                    ...
                    if (Plat.DEBUG)
                        LogUtils.i("aaaaaa", "alarmid:" + alarmId);
    ...
    public void onStatusChanged() {
        ...
        if (Plat.DEBUG)
            Log.i("water-cg", "preStatus:" + preStatus + " status:" + status + " alarm:" + alarm + " input_tds:" + input_tds + " output_tds:" + output_tds +
                " work_time:" + work_time + " water_cleaend:" + water_cleaend + " pp:" + filter_state_pp + " cto:" + filter_state_cto + " ro1" + filter_state_ro1
                + " ro2" + filter_state_ro2 + "time_left:" + filter_time_pp + "time_left:" + filter_time_cto + "time_left:" + filter_time_ro1 + "time_left:" + filter_time_ro2 + "waterCleanQulity:" +
                waterCleanQulity
        );
