...
public class RecipeDeviceHelper {
    ...
    public static boolean queryIfContain(Recipe recipe, String dc, String cookbookType) {
        if (cookbookType != null && !cookbookType.equals(recipe.getCookbookType())){
            return false;
        }

        return queryIfContainDC(recipe.getJs_dcs(),dc);
    }
}
